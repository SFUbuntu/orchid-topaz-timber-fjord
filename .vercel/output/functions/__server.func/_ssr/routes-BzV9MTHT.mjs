...
var Sfx = class {
	...
	hat(when, vol = .045) {
		...
		g.gain.exponentialRampToValueAtTime(1e-4, when + .06);
		src.connect(f);
		f.connect(g);
		g.connect(this.music);
		src.start(when);
...
var VectorFangGame = class {
	...
	update(dt) {
		...
		if ((this.launchT <= 0 || this.launchPhase() === "shot" || this.launchPhase() === "lift") && (this.demo || this.hack || this.held("Space") || this.held("KeyJ") || this.touch.fire) && this.fireCd <= 0) this.fire();
